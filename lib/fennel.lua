  ...
  local function try_readline_21(opts, ok, readline)
    if ok then
      ...
      opts.readChunk = function(parser_state)
        local _799_0 = readline.readline(prompt_for((0 == parser_state["stack-size"])))
        if (nil ~= _799_0) then
          local input = _799_0
          return (input .. "\n")
        end
...
package.preload["fennel.specials"] = package.preload["fennel.specials"] or function(...)
  ...
  local function wrap_env(env)
    ...
    local function _476_(_, key, value)
      if utils["string?"](key) then
    ...
    local function _478_()
      ...
      do
        ...
        for k, v in utils.stablepairs(env) do
          ...
          if utils["string?"](k) then
            _480_ = compiler["global-unmangling"](k)
          else
            _480_ = k
          end
          k_15_, v_16_ = _480_, v
      ...
      return next, _479_, nil
    end
    return setmetatable({}, {__index = _474_, __newindex = _476_, __pairs = _478_})
  end
  ...
  local function current_global_names(_3fenv)
    local mt = nil
    do
      local _483_0 = getmetatable(_3fenv)
      if ((_G.type(_483_0) == "table") and (nil ~= _483_0.__pairs)) then
        local mtpairs = _483_0.__pairs
        local tbl_14_ = {}
  ...
  local function load_code(code, _3fenv, _3ffilename)
    ...
    local _488_0, _489_0 = rawget(_G, "setfenv"), rawget(_G, "loadstring")
    if ((nil ~= _488_0) and (nil ~= _489_0)) then
      local setfenv = _488_0
      local loadstring = _489_0
  ...
  local function doc_2a(tgt, name)
    ...
    if not tgt then
      ...
      local function _492_()
        local _491_0 = getmetatable(tgt)
        if ((_G.type(_491_0) == "table") and true) then
          local __call = _491_0.__call
          return ("function" == type(__call))
        end
      end
      if ((type(tgt) == "function") or _492_()) then
  ...
  local function compile_value(v)
    ...
    local chunk = {}
    local _502_ = compiler.compile1(v, scope, chunk, opts)
    local _503_ = _502_[1]
    local v0 = _503_[1]
    return v0
  end
  ...
  local function get_fn_name(ast, scope, fn_name, multi)
    if (fn_name and (fn_name[1] ~= "nil")) then
      local _508_
      if not multi then
        _508_ = compiler["declare-local"](fn_name, scope, ast)
      else
        _508_ = compiler["symbol-to-expression"](fn_name, scope)[1]
      end
      return _508_, not multi, 3
    else
      return nil, true, 2
    end
  end
  local function compile_named_fn(ast, f_scope, f_chunk, parent, index, fn_name, local_3f, arg_name_list, f_metadata)
    ...
    local _511_
    if local_3f then
      _511_ = "local function %s(%s)"
    else
      _511_ = "%s = function(%s)"
    end
    compiler.emit(parent, string.format(_511_, fn_name, table.concat(arg_name_list, ", ")), ast)
  ...
  local function get_function_metadata(ast, arg_list, index)
    local function _514_(_241, _242)
      local tbl_14_ = _241
    ...
    local function _516_(_241, _242)
      _241["fnl/docstring"] = _242
      return _241
    end
    return maybe_metadata(ast, utils["kv-table?"], _514_, maybe_metadata(ast, utils["string?"], _516_, {["fnl/arglist"] = arg_list}, index))
  end
  SPECIALS.fn = function(ast, scope, parent, opts)
    local f_scope = nil
    do
      local _517_0 = compiler["make-scope"](scope)
      _517_0["vararg"] = false
      f_scope = _517_0
    end
    local f_chunk = {}
  ...
  SPECIALS.lua = function(ast, _, parent)
    ...
    local _523_
    do
      local _522_0 = utils["sym?"](ast[2])
      if (nil ~= _522_0) then
        _523_ = tostring(_522_0)
      else
        _523_ = _522_0
      end
    end
    ...
    local _527_
    do
      local _526_0 = utils["sym?"](ast[3])
      if (nil ~= _526_0) then
        _527_ = tostring(_526_0)
      else
        _527_ = _526_0
      end
    end
  ...
  local function dot(ast, scope, parent)
    ...
    local _530_ = compiler.compile1(lhs_node, scope, parent, {nval = 1})
    local lhs = _530_[1]
    if (len == 2) then
      return tostring(lhs)
    else
      ...
      for i = 3, len do
        ...
        if (utils["string?"](index) and utils["valid-lua-identifier?"](index)) then
          ...
          local _531_ = compiler.compile1(index, scope, parent, {nval = 1})
          local index0 = _531_[1]
  ...
  SPECIALS.let = function(_538_0, scope, parent, opts)
    local _539_ = _538_0
    local _ = _539_[1]
    local bindings = _539_[2]
    local ast = _539_
  ...
  local function if_2a(ast, scope, parent, opts)
    ...
    if (#ast == 2) then
      ...
      for i = 2, (#ast - 1), 2 do
        local condchunk = {}
        local _548_ = compiler.compile1(ast[i], do_scope, condchunk, {nval = 1})
        local cond = _548_[1]
  ...
  local function remove_until_condition(bindings, ast)
    ...
    for i = (#bindings - 1), 3, -1 do
      local _554_0 = clause_3f(bindings[i])
      if ((_554_0 == false) or (_554_0 == nil)) then
      elseif (nil ~= _554_0) then
        local clause = _554_0
  ...
  local function compile_until(_3fcondition, scope, chunk)
    if _3fcondition then
      local _556_ = compiler.compile1(_3fcondition, scope, chunk, {nval = 1})
      local condition_lua = _556_[1]
  ...
  local function method_call(ast, scope, parent)
    ...
    local _567_ = compiler.compile1(ast[2], scope, parent, {nval = 1})
    local target = _567_[1]
    local args = {}
    for i = 4, #ast do
      local subexprs = nil
      local _568_
      ...
      subexprs = compiler.compile1(ast[i], scope, parent, {nval = _568_})
      local tbl_17_ = args
      local i_18_ = #tbl_17_
    ...
    local _571_0 = method_special_type(ast)
    if (_571_0 == "native") then
      return native_method_call(ast, scope, parent, target, args)
    elseif (_571_0 == "nonnative") then
      return nonnative_method_call(ast, scope, parent, target, args)
    elseif (_571_0 == "binding") then
  ...
  local function short_circuit_safe_3f(x, scope)
    ...
    elseif utils["list?"](x) then
      if utils["sym?"](x[1]) then
        local _584_0 = str1(x)
        if ((_584_0 == "fn") or (_584_0 == "hashfn") or (_584_0 == "let") or (_584_0 == "local") or (_584_0 == "var") or (_584_0 == "set") or (_584_0 == "tset") or (_584_0 == "if") or (_584_0 == "each") or (_584_0 == "for") or (_584_0 == "while") or (_584_0 == "do") or (_584_0 == "lua") or (_584_0 == "global")) then
          return false
        elseif (((_584_0 == "<") or (_584_0 == ">") or (_584_0 == "<=") or (_584_0 == ">=") or (_584_0 == "=") or (_584_0 == "not=") or (_584_0 == "~=")) and (comparator_special_type(x) == "binding")) then
          return false
        else
          local function _585_()
            return (1 ~= x[2])
          end
          if ((_584_0 == "pick-values") and _585_()) then
            return false
          else
  ...
  local function emit_short_circuit_if(ast, scope, parent, name, subast, accumulator, expr_string, setter)
    ...
    compiler.emit(parent, ("if %s then"):format(_596_()), subast)
    do
      local chunk = {}
  ...
  local function define_arithmetic_special(name, zero_arity, unary_prefix, _3flua_name)
    local _602_
    do
      local _601_0 = (_3flua_name or name)
      local function _603_(...)
        return operator_special(_601_0, zero_arity, unary_prefix, ...)
      end
      _602_ = _603_
    end
    SPECIALS[name] = _602_
  ...
  local function bitop_special(native_name, lib_name, zero_arity, unary_prefix, ast, scope, parent)
    if (#ast == 1) then
      ...
      for i = 2, len do
        ...
        subexprs = compiler.compile1(ast[i], scope, parent, {nval = _604_})
  ...
  SPECIALS.bnot = function(ast, scope, parent)
    compiler.assert((#ast == 2), "expected one argument", ast)
    local _612_ = compiler.compile1(ast[2], scope, parent, {nval = 1})
    local value = _612_[1]
    if utils.root.options.useBitLib then
  ...
  local function native_comparator(op, _614_0, scope, parent)
    local _615_ = _614_0
    local _ = _615_[1]
    local lhs_ast = _615_[2]
    local rhs_ast = _615_[3]
    local _616_ = compiler.compile1(lhs_ast, scope, parent, {nval = 1})
    local lhs = _616_[1]
    local _617_ = compiler.compile1(rhs_ast, scope, parent, {nval = 1})
    local rhs = _617_[1]
  ...
  local function binding_comparator(op, chain_op, ast, scope, parent)
    ...
    return ("(" .. table.concat(_621_, chain) .. ")")
  end
  local function define_comparator_special(name, _3flua_op, _3fchain_op)
    do
      ...
      local function opfn(ast, scope, parent)
        ...
        local _623_0 = comparator_special_type(ast)
        if (_623_0 == "native") then
          return native_comparator(op, ast, scope, parent)
        elseif (_623_0 == "idempotent") then
          return idempotent_comparator(op, _3fchain_op, ast, scope, parent)
        elseif (_623_0 == "binding") then
  ...
  local function make_compiler_env(ast, scope, parent, _3fopts)
    local provided = nil
    do
      local _630_0 = (_3fopts or utils.root.options)
      if ((_G.type(_630_0) == "table") and (_630_0["compiler-env"] == "strict")) then
        provided = safe_compiler_env()
      elseif ((_G.type(_630_0) == "table") and (nil ~= _630_0.compilerEnv)) then
        local compilerEnv = _630_0.compilerEnv
        provided = compilerEnv
      elseif ((_G.type(_630_0) == "table") and (nil ~= _630_0["compiler-env"])) then
        local compiler_env = _630_0["compiler-env"]
    ...
    local function _633_(symbol)
      compiler.assert(compiler.scopes.macro, "must call from macro", ast)
      return compiler.scopes.macro.manglings[tostring(symbol)]
    end
    local function _634_(base)
      return utils.sym(compiler.gensym((compiler.scopes.macro or scope), base))
    end
    local function _635_(form)
      compiler.assert(compiler.scopes.macro, "must call from macro", ast)
      return compiler.macroexpand(form, compiler.scopes.macro)
    end
    env = {["assert-compile"] = compiler.assert, ["ast-source"] = utils["ast-source"], ["comment?"] = utils["comment?"], ["fennel-module-name"] = fennel_module_name, ["get-scope"] = _632_, ["in-scope?"] = _633_, ["list?"] = utils["list?"], ["macro-loaded"] = macro_loaded, ["multi-sym?"] = utils["multi-sym?"], ["sequence?"] = utils["sequence?"], ["sym?"] = utils["sym?"], ["table?"] = utils["table?"], ["varg?"] = utils["varg?"], _AST = ast, _CHUNK = parent, _IS_COMPILER = true, _SCOPE = scope, _SPECIALS = compiler.scopes.global.specials, _VARARG = utils.varg(), comment = utils.comment, gensym = _634_, list = utils.list, macroexpand = _635_, sequence = utils.sequence, sym = utils.sym, unpack = unpack, version = utils.version, view = view}
    env._G = env
  ...
  local _638_ = _636_(...)
  local dirsep = _638_[1]
  local pathsep = _638_[2]
  local pathmark = _638_[3]
  ...
  local function search_module(modulename, _3fpathstring)
    ...
    local function try_path(path)
      ...
      local _639_0 = (io.open(filename) or io.open(filename2))
      if (nil ~= _639_0) then
        local file = _639_0
        file:close()
        return filename
    ...
    local function find_in_path(start, _3ftried_paths)
      local _641_0 = fullpath:match(pattern, start)
      if (nil ~= _641_0) then
        local path = _641_0
        local _642_0, _643_0 = try_path(path)
        if (nil ~= _642_0) then
          local filename = _642_0
          return filename
        elseif ((_642_0 == nil) and (nil ~= _643_0)) then
          local error = _643_0
          local function _645_()
            local _644_0 = (_3ftried_paths or {})
            table.insert(_644_0, error)
            return _644_0
          end
          return find_in_path((start + #path + 1), _645_())
        end
      else
        local _ = _641_0
  ...
  local function make_searcher(_3foptions)
    local function _650_(module_name)
      local opts = utils.copy(utils.root.options)
      for k, v in pairs((_3foptions or {})) do
        opts[k] = v
      end
      opts["module-name"] = module_name
      local _651_0, _652_0 = search_module(module_name)
      if (nil ~= _651_0) then
        local filename = _651_0
        local function _653_(...)
          return utils["fennel-module"].dofile(filename, opts, ...)
        end
        return _653_, filename
      elseif ((_651_0 == nil) and (nil ~= _652_0)) then
        local error = _652_0
        return error
      end
    end
  ...
  local function fennel_macro_searcher(module_name)
    local opts = nil
    do
      local _655_0 = utils.copy(utils.root.options)
      _655_0["module-name"] = module_name
      _655_0["env"] = "_COMPILER"
      _655_0["requireAsInclude"] = false
      _655_0["allowedGlobals"] = nil
      opts = _655_0
    end
    local _656_0 = search_module(module_name, utils["fennel-module"]["macro-path"])
    if (nil ~= _656_0) then
      ...
      return _657_, filename
    end
  end
  local function lua_macro_searcher(module_name)
    local _662_0 = search_module(module_name, package.path)
    if (nil ~= _662_0) then
      local filename = _662_0
      local code = nil
      do
        ...
        code = close_handlers_10_(_G.xpcall(_664_, (package.loaded.fennel or debug).traceback))
      end
  ...
  local function search_macro_module(modname, n)
    local _666_0 = macro_searchers[n]
    if (nil ~= _666_0) then
      local f = _666_0
      local _667_0, _668_0 = f(modname)
      if ((nil ~= _667_0) and true) then
        local loader = _667_0
        local _3ffilename = _668_0
  ...
  local function sandbox_fennel_module(modname)
    if ((modname == "fennel.macros") or (package and package.loaded and ("table" == type(package.loaded[modname])) and (package.loaded[modname].metadata == compiler.metadata))) then
      local function _671_(_, ...)
        return (compiler.metadata):setall(...)
      end
      return {metadata = {setall = _671_}, view = view}
    end
  end
  local function _673_(modname)
    ...
    return (macro_loaded[modname] or sandbox_fennel_module(modname) or _674_())
  end
  safe_require = _673_
  ...
  local function resolve_module_name(_675_0, _scope, _parent, opts)
    local _676_ = _675_0
    local second = _676_[2]
    local filename = _676_["filename"]
  ...
  local function include_path(ast, opts, path, mod, fennel_3f)
    ...
    do
      ...
      src = close_handlers_10_(_G.xpcall(_682_, (package.loaded.fennel or debug).traceback))
    end
  ...
  SPECIALS.include = function(ast, scope, parent, opts)
    ...
    local modexpr = nil
    do
      local _685_0, _686_0 = pcall(resolve_module_name, ast, scope, parent, opts)
      if ((_685_0 == true) and (nil ~= _686_0)) then
        local modname = _686_0
    ...
    if ((modexpr.type ~= "literal") or ((modexpr[1]):byte() ~= 34)) then
      ...
      local function _690_()
        local _689_0 = search_module(mod)
        if (nil ~= _689_0) then
          local fennel_path = _689_0
      ...
      res = ((utils["member?"](mod, (utils.root.options.skipInclude or {})) and opts.fallback(modexpr, true)) or include_circular_fallback(mod, modexpr, opts.fallback, ast) or utils.root.scope.includes[mod] or _690_())
  ...
  SPECIALS["pick-values"] = function(ast, scope, parent)
    ...
    if (1 == n) then
      local _694_ = compiler.compile1(vals, scope, parent, {nval = 1})
      local _695_ = _694_[1]
      local expr = _695_[1]
      return {("(" .. expr .. ")")}
    elseif (0 == n) then
...
package.preload["fennel.compiler"] = package.preload["fennel.compiler"] or function(...)
  ...
  local function global_mangling(str)
    if utils["valid-lua-identifier?"](str) then
      ...
      return ("__fnl_global__" .. str:gsub("[^%w]", _283_))
    end
  end
  local function global_unmangling(identifier)
    local _285_0 = string.match(identifier, "^__fnl_global__(.*)$")
    if (nil ~= _285_0) then
      local rest = _285_0
      local _286_0 = nil
      ...
      _286_0 = string.gsub(rest, "_[%da-f][%da-f]", _287_)
      return _286_0
    else
      local _ = _285_0
      return identifier
  ...
  local function global_allowed_3f(name)
    local allowed = nil
    do
      local _289_0 = utils.root.options
      if (nil ~= _289_0) then
        _289_0 = _289_0.allowedGlobals
      end
      allowed = _289_0
    end
  ...
  local function autogensym(base, scope)
    local _295_0 = utils["multi-sym?"](base)
    if (nil ~= _295_0) then
      local parts = _295_0
      ...
      return (scope.autogensyms[base] or _296_())
    end
  end
  ...
  local function declare_local(symbol, scope, ast, _3fvar_3f, _3fdeferred_scope_changes)
    ...
    local mangling = nil
    local function _301_(_241)
      return string.format("_%02x", _241:byte())
    end
    mangling = string.gsub(string.gsub(raw, "-", "_"), "[^%w_]", _301_)
  ...
  local function symbol_to_expression(symbol, scope, _3freference_3f)
    ...
    local function _306_()
      local _305_0 = utils.root.options
      if (nil ~= _305_0) then
        _305_0 = _305_0.allowedGlobals
      end
      return _305_0
    end
    if (_306_() and not local_3f and scope.parent) then
  ...
  local function flatten_chunk(file_sourcemap, chunk, tab, depth)
    if chunk.leaf then
      local _316_ = utils["ast-source"](chunk.ast)
      local endline = _316_["endline"]
      ...
      do
        ...
        if (_318_0 == true) then
          tab0 = "  "
        elseif (_318_0 == false) then
          tab0 = ""
        elseif (nil ~= _318_0) then
          local tab1 = _318_0
          tab0 = tab1
        elseif (_318_0 == nil) then
          tab0 = ""
        else
        tab0 = nil
        end
  ...
  local function make_metadata()
    local function _328_(self, tgt, _3fkey)
      if self[tgt] then
        if (nil ~= _3fkey) then
    ...
    local function _331_(self, tgt, key, value)
      self[tgt] = (self[tgt] or {})
      self[tgt][key] = value
      return tgt
    end
    local function _332_(self, tgt, ...)
      local kv_len = select("#", ...)
      local kvs = {...}
      if ((kv_len % 2) ~= 0) then
    ...
    return setmetatable({}, {__index = {get = _328_, set = _331_, setall = _332_}, __mode = "k"})
  end
  ...
  local function handle_compile_opts(exprs, parent, opts, ast)
    ...
    if opts.target then
      ...
      emit(parent, string.format("%s = %s", opts.target, _342_()), ast)
    end
  ...
  local function find_macro(ast, scope)
    local macro_2a = nil
    do
      local _345_0 = utils["sym?"](ast[1])
      if (_345_0 ~= nil) then
        local _346_0 = tostring(_345_0)
        if (_346_0 ~= nil) then
          macro_2a = scope.macros[_346_0]
        else
          macro_2a = _346_0
        end
      else
  ...
  local function propagate_trace_info(_350_0, _index, node)
    local _351_ = _350_0
    local byteend = _351_["byteend"]
    local bytestart = _351_["bytestart"]
    local filename = _351_["filename"]
    local line = _351_["line"]
    do
  ...
  local function macroexpand_2a(ast, scope, _3fonce)
    ...
    if utils["list?"](ast) then
      _356_0 = find_macro(ast, scope)
    else
    _356_0 = nil
    end
    if (_356_0 == false) then
      return ast
    elseif (nil ~= _356_0) then
      local macro_2a = _356_0
  ...
  local function callable_3f(_366_0, ctype, callee)
    local _367_ = _366_0
    local call_ast = _367_[1]
  ...
  local function compile_function_call(ast, scope, parent, opts, compile1, len)
    local _369_ = compile1(ast[1], scope, parent, {nval = 1})[1]
    local callee = _369_[1]
    local ctype = _369_["type"]
    local fargs = {}
    ...
    for i = 2, len do
      ...
      subexprs = compile1(ast[i], scope, parent, {nval = _370_})
  ...
  local function compile_varg(ast, scope, parent, opts)
    ...
    if scope.hashfn then
      ...
      _375_ = "unexpected vararg"
    end
    assert_compile(scope.vararg, _375_, ast)
  ...
  do
    ...
    view_opts = {["negative-infinity"] = "(-1/0)", ["negative-nan"] = _378_, infinity = "(1/0)", nan = _380_}
  end
  local function compile_scalar(ast, _scope, parent, opts)
    local compiled = nil
    do
      local _382_0 = type(ast)
      if (_382_0 == "nil") then
        compiled = "nil"
      elseif (_382_0 == "boolean") then
        compiled = tostring(ast)
      elseif (_382_0 == "string") then
        compiled = serialize_string(ast)
      elseif (_382_0 == "number") then
  ...
  local function compile_table(ast, scope, parent, opts, compile1)
    local function escape_key(k)
      if ((type(k) == "string") and utils["valid-lua-identifier?"](k)) then
        ...
        local _384_ = compile1(k, scope, parent, {nval = 1})
        local compiled = _384_[1]
    ...
    do
      ...
      for k in utils.stablepairs(ast) do
        local val_19_ = nil
        if not keys[k] then
          local _387_ = compile1(ast[k], scope, parent, {nval = 1})
          local v = _387_[1]
  ...
  local function destructure(to, from, ast, scope, parent, opts)
    local opts0 = (opts or {})
    local _391_ = opts0
    local declaration = _391_["declaration"]
    local forceglobal = _391_["forceglobal"]
    local forceset = _391_["forceset"]
    local isvar = _391_["isvar"]
    local symtype = _391_["symtype"]
    ...
    local function getname(symbol, ast0)
      ...
      if declaration then
        ...
        if forceglobal then
          ...
          local _396_
          do
            local _395_0 = utils.root.options
            if (nil ~= _395_0) then
              _395_0 = _395_0.allowedGlobals
            end
            _396_ = _395_0
          end
          if _396_ then
    ...
    local function dynamic_set_target(_410_0)
      local _411_ = _410_0
      local _ = _411_[1]
      local target = _411_[2]
      local keys = {(table.unpack or unpack)(_411_, 3)}
    ...
    local function destructure_kv_rest(s, v, left, excluded_keys, destructure1)
      ...
      exclude_str = table.concat(_416_, ", ")
    ...
    local function destructure_rest(s, k, left, destructure1)
      ...
      assert_compile((utils["sequence?"](left) and _418_()), "expected rest argument before last parameter", left)
    ...
    local function optimize_table_destructure_3f(left, right)
      ...
      return (utils["sequence?"](left) and utils["sequence?"](right) and _419_())
    end
    local function destructure_table(left, rightexprs, top_3f, destructure1, up1)
      if optimize_table_destructure_3f(left, rightexprs) then
        ...
        do
          local _420_0 = nil
          if top_3f then
            _420_0 = exprs1(compile1(from, scope, parent))
          else
            _420_0 = exprs1(rightexprs)
          end
          if (_420_0 == "") then
            right = "nil"
          elseif (nil ~= _420_0) then
            local right0 = _420_0
            right = right0
          else
          right = nil
  ...
  local function compile_asts(asts, options)
    ...
    local _434_ = utils.root
    _434_["set-reset"](_434_)
  ...
  local function compile(from, _3fopts)
    local _437_0 = type(from)
    if (_437_0 == "userdata") then
      local function _438_()
        local _439_0 = from:read(1)
        if (nil ~= _439_0) then
          return _439_0:byte()
        else
          return _439_0
      ...
      return compile_stream(_438_, _3fopts)
    elseif (_437_0 == "function") then
  ...
  local function traceback_frame(info)
    ...
    elseif (info.what == "C") then
      ...
      if (info.what == "Lua") then
        ...
        return string.format("\9%s:%d: in function %s", info.short_src, info.currentline, _444_())
  ...
  local function traceback(_3fmsg, _3fstart)
    local _447_0 = type(_3fmsg)
    if ((_447_0 == "nil") or (_447_0 == "string")) then
      local msg = (_3fmsg or "")
      if ((msg:find("^%g+:%d+:%d+ Compile error:.*") or msg:find("^%g+:%d+:%d+ Parse error:.*")) and not utils["debug-on?"]("trace")) then
        ...
        while not done_3f do
          do
            local _449_0 = lua_getinfo(level, "Sln")
            if (_449_0 == nil) then
              done_3f = true
            elseif (nil ~= _449_0) then
              local info = _449_0
  ...
  local function do_quote(form, scope, parent, runtime_3f)
    ...
    elseif utils["sequence?"](form) then
      ...
      return string.format("setmetatable({%s}, {filename=%s, line=%s, sequence=%s})", mixed_concat(mapped, ", "), filename, _469_, "(getmetatable(_G.sequence()))['sequence']")
    elseif (type(form) == "table") then
      ...
      return string.format("setmetatable({%s}, {filename=%s, line=%s})", mixed_concat(mapped, ", "), filename, _472_())
